...
/** SIP Response Reason codes */
enum sip_resp_code {
	// 1xx—Provisional Responses
	SIP_RESP_TRYING = 100,
	SIP_RESP_RINGING = 180,
	SIP_RESP_CALL_BEING_FORWARDED = 181,
	SIP_RESP_QUEUED = 182,
	SIP_RESP_INPROGRESS = 183,
	SIP_RESP_DLG_TERMINATED = 199,

	// 2xx—Successful Responses
	SIP_RESP_OK = 200,
	SIP_RESP_ACCEPTED = 202,
	SIP_RESP_NO_NOTIFICATION = 204,

	// 3xx—Redirection Responses
	SIP_RESP_MULTIPLE_CHOICES = 300,
	SIP_RESP_MOVED_PERMANETLY = 301,
	SIP_RESP_MOVED_TEMPORARILY = 302,
	SIP_RESP_USER_PROXY = 305,
	SIP_RESP_ALTERNATIVE_SERVICE = 380,

	// 4xx—Client Failure Responses
	SIP_RESP_UNAUTHORIZED = 401,
	SIP_RESP_NOT_FOUND = 404,
	SIP_RESP_PROXY_AUTH_REQUIRED = 407,
	SIP_RESP_REQUEST_TIMEOUT = 408,
	SIP_RESP_GONE = 410,
	SIP_RESP_UNKNOWN_RES_PRIORITY = 417,
	SIP_RESP_LOWER_RES_PRIORITY = 418,
	SIP_RESP_TEMP_UNAVAILABLE = 480,
	SIP_RESP_CALLNOTEXIST = 481,
	SIP_RESP_BUSY_HERE = 486,
	SIP_RESP_REQUREST_TERMINATED = 487,
	SIP_RESP_PREEMPTION = 495,

	// 5xx—Server Failure Responses	
	SIP_RESP_SERVER_INTERNAL_ERR = 500,
	SIP_RESP_SERVICE_UNAVAILABLE = 503,
};
