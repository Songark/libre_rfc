...
int main(int argc, char *argv[])
{
	...
	/* Register DSN namespaces */
	err |= sip_accept_rplist_append("dsn.routine", 1);
	err |= sip_accept_rplist_append("dsn.priority", 2);
	err |= sip_accept_rplist_append("dsn.immediate", 3);
	err |= sip_accept_rplist_append("dsn.flash", 4);
	err |= sip_accept_rplist_append("dsn.flash-override", 5);

	/* Register DRSN namespaces */
	err |= sip_accept_rplist_append("drsn.routine", 6);
	err |= sip_accept_rplist_append("drsn.priority", 7);
	err |= sip_accept_rplist_append("drsn.immediate", 8);
	err |= sip_accept_rplist_append("drsn.flash", 9);
	err |= sip_accept_rplist_append("drsn.flash-override", 10);

	/* Register Q735 namespaces */
	err |= sip_accept_rplist_append("q735.4", 11);
	err |= sip_accept_rplist_append("q735.3", 12);
	err |= sip_accept_rplist_append("q735.2", 13);
	err |= sip_accept_rplist_append("q735.1", 14);
	err |= sip_accept_rplist_append("q735.0", 15);

	/* Register ETS namespaces */
	err |= sip_accept_rplist_append("ets.4", 16);
	err |= sip_accept_rplist_append("ets.3", 17);
	err |= sip_accept_rplist_append("ets.2", 18);
	err |= sip_accept_rplist_append("ets.1", 19);
	err |= sip_accept_rplist_append("ets.0", 20);

	/* Register WPS namespaces */
	err |= sip_accept_rplist_append("wps.4", 21);
	err |= sip_accept_rplist_append("wps.3", 22);
	err |= sip_accept_rplist_append("wps.2", 23);
	err |= sip_accept_rplist_append("wps.1", 24);
	err |= sip_accept_rplist_append("wps.0", 25);
	if (err)
		goto out;
